...
class ModelFieldDescriptor():
    ...
    def object_type(self) -> str:
        if self.descriptor.message_type is not None:
    ...
    def __init__(self, descriptor: FieldDescriptor):
...
class ModelMessageDescriptor():
    ...
    def __init__(self, descriptor: Descriptor):
        ...
        for field in descriptor.fields:
            self.fields.append(ModelFieldDescriptor(field))
...
class ModelModuleDescriptor():
    ...
    def __init__(self, descriptor: FileDescriptor):
        ...
        for message_type in descriptor.message_types_by_name:
            ...
            self.messages.append(ModelMessageDescriptor(message))
...
class ModelGeneratorDoc():
    def __init__(self, modules: List[FileDescriptor]):
        ...
        for module in modules:
            self.modules.append(ModelModuleDescriptor(module))
